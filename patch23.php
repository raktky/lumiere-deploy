<?php
/* patch23: q.php itinerary render — patch22 anchor missed (indent). Insert before `<div class="total">` (indent-agnostic). */
error_reporting(E_ALL & ~E_DEPRECATED & ~E_WARNING);
$root='/var/www/lumiere/experience';
$f="$root/q.php";
if(!is_file($f)){ die("q.php missing\n"); }
$c=file_get_contents($f);
if(strpos($c,'day-by-day plan')!==false){ echo "already present\nDONE\n"; return; }
$needle='<div class="total">';
if(strpos($c,$needle)===false){ echo "total anchor missing\nDONE\n"; return; }
$block = <<<'PHP'
